...
## 📖 Guias
- [Guias Completo](./GUIAS-COMPLETO.md)
...
- [Estratégia de Envio](./lovable/ESTRATEGIA-ENVIO-LOVABLE.md) ⭐

## 📜 Regras para Agentes
- [Regras Gerais](./regras-guias/REGRAS-GERAIS-AGENTES.md) ⭐
- [Validação de Conteúdo](./regras-guias/REGRAS-VALIDACAO-CONTEUDO.md) ⭐

## 💰 Preços e Planos
- [Localização dos Preços](./PRECOS-PLANOS-LOCALIZACAO.md) ⭐

---

**Nota:** Documentos marcados com ⭐ são os mais importantes para envio ao Lovable.
