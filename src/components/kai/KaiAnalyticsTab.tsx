...
import { useMetricoolAnalytics as useLateAnalytics, PlatformMetrics } from "@/hooks/useMetricoolAnalytics";
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Métricas em tempo real via Metricool{client?.name ? ` — ${client.name}` : ""}
          </p>
        </div>
