...
const STATUS_AFTER_GENERATION_OPTIONS: {
...
}[] = [
  {
    value: 'idea',
    label: 'Ideias',
    description: 'Card cai na coluna Ideias. Ainda precisa passar pelo gate de aprovação.',
    icon: Lightbulb,
  ...
  },
  {
    ...
    label: 'Aprovar',
    description: 'Card já entra no gate Aprovar — você decide se libera pra produção ou descarta.',
    icon: Lightbulb,
  ...
  },
  {
    value: 'draft',
    label: 'Iniciar',
    description: 'Card já vai pra Iniciar (produção). Bom pra iterar antes de marcar como Pronto.',
    icon: FileEdit,
  ...
  },
  {
    value: 'approved',
    label: 'Pronto',
    description: 'Card cai como Pronto, segue pra agendar. Use só se confia 100% no template.',
    icon: ThumbsUp,
